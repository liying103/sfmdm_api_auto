...
class EmailUtils:
    ...
    def __init__(self,smtp_body,smtp_attch_path=None):
        ...
        self.smtp_port = 25
        self.smtp_sender = '1134106939@qq.com'
        self.smtp_password = 'ypqxltkyuiucfgjh' # 邮箱授权码
        self.smtp_receiver = configutils.get_inidata('email','receiver')
        self.smtp_cc = '1134106939@qq.com'
        self.smtp_subject = '智燃云接口自动化测试报告'
...
if __name__ == "__main__":
    email_u = EmailUtils('test使用','../reports/2021-01-16 17:50:13.html')
    email_u.send_mail()
